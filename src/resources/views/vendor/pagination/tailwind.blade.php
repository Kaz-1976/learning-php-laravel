@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        <div class="flex justify-between flex-1 sm:hidden">
            ...
            @else
                <a href="{{ \App\Helpers\UrlHelper::generateUrl($paginator->previousPageUrl()) }}"
            ...
            @if ($paginator->hasMorePages())
                <a href="{{ \App\Helpers\UrlHelper::generateUrl($paginator->nextPageUrl()) }}"
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            ...
            <div>
                <span class="relative z-0 inline-flex rtl:flex-row-reverse shadow-sm rounded-md">
                    ...
                    @foreach ($elements as $element)
                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                ...
                                @else
                                    <a href="{{ \App\Helpers\UrlHelper::generateUrl($url) }}"
                    ...
                    {{-- Next Page Link --}}
                    @if ($paginator->hasMorePages())
                        <a href="{{ \App\Helpers\UrlHelper::generateUrl($paginator->nextPageUrl()) }}" rel="next"
