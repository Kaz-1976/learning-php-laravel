...
<div class="container flex flex-col gap-4">
    <div class="container p-4 border-solid border-2 rounded-lg border-sky-950 dark:border-sky-50">
        <form class="flex flex-row gap-4" id="register" action="{{ url('ec_site/products/store', null, $is_production) }}" method="POST"
        ...
        @foreach ($ec_products as $ec_product)
            ...
            <div
                ...
                <form class="flex flex-row basis-full gap-2" id="{{ $form[$ec_product->id] }}"
                    action="{{ url('ec_site/products.update', null, $is_production) }}" method="POST" enctype="multipart/form-data">
                    @csrf
