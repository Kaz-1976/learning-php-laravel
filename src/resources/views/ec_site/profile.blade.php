    ...
    <form class="flex flex-col gap-1 p-4 border-solid border-2 rounded-lg border-sky-950 dark:border-sky-50"
        ...
        <div>
            ...
            <x-text-input class="block mt-1 w-full" type="text" id="register-user-id" name="user_id"
                :value="$ec_user->user_id" required autofocus autocomplete="user_id" placeholder="EcTaro" />
            @if (old('register') == '1')
        ...
        <div>
            ...
            <x-text-input class="block mt-1 w-full" type="text" id="register-email" name="email"
                :value="$ec_user->email" required autofocus autocomplete="email" placeholder="ec-taro@example.local" />
            @if (old('register') == '1')
