    ...
    <div class="w-full">
        ...
        <div
            ...
            <form class="flex flex-col md:flex-row basis-full w-full gap-2 px-1" id="update-{{ $ec_cart_detail->id }}"
                action="@generateUrl('cart/update')" method="POST"
                    ...
                    <div class="flex flex-col basis-4/5 gap-1">
                        <div class="block">
                            ...
                            <x-text-input class="block mt-1 w-full" type="text"
                                id="update-{{ $ec_cart_detail->id }}-name" name="name" :readonly="true"
                        ...
                        <div class="block">
                            ...
                            <div class="flex flex-row content-stretch gap-2">
                                <x-text-input class="block mt-1 w-full text-right" type="number"
                                    id="update-{{ $ec_cart_detail->id }}-price" name="price" :readonly="true"
                        ...
                        <div class="block">
                            ...
                            <div class="flex flex-row content-stretch gap-2">
                                <x-text-input class="block mt-1 w-full text-right" type="number"
                                    ...
                                    min="1" max="{{ $ec_cart_detail->ec_products->qty }}" required autofocus />
                        ...
                        <div class="block">
                            ...
                            <div class="flex flex-row content-stretch gap-2">
                                <x-text-input class="block mt-1 w-full text-right" type="number"
                                    id="update-{{ $ec_cart_detail->id }}-sub-total" name="sub-total" :disabled="true"
