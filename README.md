...
- **ユーザー関連機能**: ユーザー登録、ユーザー管理、ログイン機能
- **商品管理機能**: 商品の新規登録、価格・在庫・公開設定
- **商品一覧機能**: 公開中の商品を一覧表示し、カートに追加
- **ショッピングカート機能**: 商品の購入、数量変更、削除

### 追加機能

- **パスワードリセット機能**: 登録メールアドレスへのリセットリンク送信
- **マイページ関連機能**:
	- **個人情報編集機能**: パスワード変更を含む個人情報の編集。
	- **配送先管理機能**: 配送先情報の登録・修正・削除。
	- **購入履歴表示機能**: 注文ごとの購入履歴表示。
- **住所自動入力機能**: 郵便番号から住所の自動入力

## 画面遷移図

![画面遷移図](https://github.com/Kaz-1976/learning-php-laravel/blob/e5111537301a7934c7ee1aae0f59ce870adaebfc/documents/%E7%94%BB%E9%9D%A2%E9%81%B7%E7%A7%BB%E5%9B%B3.drawio.png)
